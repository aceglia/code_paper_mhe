...
if __name__ == '__main__':
    ...
    message = json.loads(recv_all(connection, Buff_size))
    b = None
    if count == 0:
        ...
        for data in data_to_show:
            if data == "force":
                p_force, win_force, app_force = init_plot_force(nbMT, "progress_bar")
        ...
        if "force" in data_to_show:
            update_plot_force(force_to_plot, p_force, app_force, plot_force_ratio, muscle_names)  # , box_force)
